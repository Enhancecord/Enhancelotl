...
func main() {
	...
	win = g.NewMasterWindow("Enhancelotl", 1200, 800, 0)
	...
	g.SingleWindow().
		...
		Layout(
			...
			g.Style().SetFontSize(20).To(
				...
				g.Dummy(0, 10),
				g.Label("Enhancelotl Version: "+buildinfo.InstallerTag+" ("+buildinfo.InstallerGitHash+")"+Ternary(IsSelfOutdated, " - OUTDATED", "")),
