...
const InstallerReleaseUrl = "https://api.github.com/repos/Enhancecord/Enhancelotl/releases/latest"

var UserAgent = "Enhancelotl/" + buildinfo.InstallerGitHash + " (https://github.com/Enhancecord/Enhancelotl)"
